...
3. Now install the sms_tropo plugin.
	* Extract the sms_tropo tarball/zip file inside the /sites/{your-site}/modules/ folder so that "sms_tropo" appears as the folder /sites/{your-site}/modules/sms_tropo/ (Don't have a {your-site}/modules/ folder? /sites/all/modules/ works fine)
	* OR `cd` to `{your-site}/modules/` and `git clone git://github.com/tropo/sms_tropo.git`
